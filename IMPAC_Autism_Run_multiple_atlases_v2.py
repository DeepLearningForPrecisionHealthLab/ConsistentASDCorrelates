...
if __name__ == '__main__':
    ...
    for sConn in ['PartialCorrelation', 'Covariance', 'Precision', 'LSGC']:#'Correlation', 
        ...
        sTargetDirectory = f"/project/bioinformatics/DLLab/Cooper/Code/AutismProject/AlternateMetrics/TrainedModels" \
                           f"/ShallowLearning/3_fold_cv_50x_random_search_{sConn}"
